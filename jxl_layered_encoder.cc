...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        vector<float> frame_high = loadImage(argv[1], num_channels, bytes_per_pixel, width_high, height_high);

        size_t width_low, height_low;
        vector<float> frame_low  = loadImage(argv[2], num_channels, bytes_per_pixel, width_low, height_low);
